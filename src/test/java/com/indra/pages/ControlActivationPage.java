...
public class ControlActivationPage extends PageObject{
    ...
    @FindBy(xpath = "//*[@id='ActivacionesForm:cedulaCliente']")
    ...
    @FindBy(xpath = "//div[contains(@id,'ActivacionesForm:tipoPlanItem329')]")
    WebElementFacade plan740;

    @FindBy(xpath = "//div[contains(@id,'ActivacionesForm:tipoPlanItem360')]")
